...
<html>
    ...
    <title>DCOMPUTER | Register</title>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
            <a class="nav-link" href="login_user.php"><i class="fas fa-sign-in-alt"></i> Login </a>
            </li>
            <li class="nav-item active">
            <a class="nav-link" href="register_user.php"><i class="fas fa-user-plus"></i> Register <span class="sr-only">(current)</span></a>
            </li>
        </ul>
    </div>
    </nav>
<br><br>
    <?php
        ...
        // $name = $username = $pass = $passcon = $email = $notelp = "";
