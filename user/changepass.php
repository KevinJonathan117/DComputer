...
require_once "connect.php";
    ...
    $data = mysqli_query($conn,"SELECT password FROM user where username = '$username'");
        ...
        if(!empty($newpassword) && !empty($renewpassword)){
            if($newpassword != $renewpassword){
                $beda = "newpassword dan renewpassword berbeda";
                    ...
                    $stmt->execute();
                    echo "<script type='text/javascript'>alert('SUKSES');window.location.href= 'index_user.php';</script>";
...
<htmL>
    <head>
        ...
        <title>DCOMPUTER | Change Password</title>
