...
<html>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link" href="login_user.php"><i class="fas fa-sign-in-alt"></i> Login <span class="sr-only">(current)</span> </a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="register_user.php"><i class="fas fa-user-plus"></i> Register </a>
            </li>
        </ul>
    </div>
    </nav>
